...
class _TranslationsSettingsScreenVi implements TranslationsSettingsScreenEn {
	...
	@override String get help_translate_subtitle => 'Nếu bạn thích Trình chạy hoạt động, bạn nên cân nhắc dịch ứng dụng này cho ngôn ngữ của bạn.';
...
extension on TranslationsVi {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings_screen.help_translate_subtitle': return 'Nếu bạn thích Trình chạy hoạt động, bạn nên cân nhắc dịch ứng dụng này cho ngôn ngữ của bạn.';
