...
class TranslationsSettingsScreenEn {
	...
	String get help_translate_subtitle => 'If you like Activity Launcher, you should consider translating this app for your language.';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings_screen.help_translate_subtitle': return 'If you like Activity Launcher, you should consider translating this app for your language.';
